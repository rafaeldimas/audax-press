...
class Metabox
{
    ...
    public function scripts() {
        ...
        if ( in_array( $screen->id, $this->get_post_type() ) ) {
            ...
            // Metabox.
            wp_enqueue_script( 'odin-admin', get_template_directory_uri() . '/app/Core/Odin/assets/js/admin.js', array( 'jquery' ), null, true );
            wp_enqueue_style( 'odin-admin', get_template_directory_uri() . '/app/Core/Odin/assets/css/admin.css', array(), null, 'all' );
    ...
    protected function field_image( $id, $current ) {
        ...
        $image = apply_filters( 'odin_placeholder_path', get_template_directory_uri() . '/app/Core/Odin/assets/images/placeholder.png' );
